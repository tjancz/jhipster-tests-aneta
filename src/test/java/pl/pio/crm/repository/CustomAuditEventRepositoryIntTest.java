...
import pl.pio.crm.config.audit.AuditEventConverter;
import pl.pio.crm.domain.PersistentAuditEvent;
...
import static pl.pio.crm.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
